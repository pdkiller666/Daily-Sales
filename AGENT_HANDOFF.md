...
> Последнее обновление: 2026-07-09 (импорт проекта в новую Replit-среду; аудит и актуализация всей md-документации, код не менялся)
...
**Последний деплой:** GitHub `70643ad` · Amvera `97d78ae3` (2026-07-08, сессия 770) — последний известный задеплоенный коммит. 09.07.2026 проект импортирован в новую Replit-среду (зависимости переустановлены, воркфлоу настроен, документация актуализирована); деплой из этой сессии ещё не выполнялся — следующий `bash deploy.sh "..."` обновит эту строку новым хэшем.
