...
_HELP_TEXTS: dict[str, str] = {
    "sales": (
        ...
        "⭐ <b>Избранное</b> — добавляйте часто продаваемые товары, чтобы не искать каждый раз\n"
        ...
        "магазина сети. Используйте кнопку «🏪 Другой магазин».\n\n"
        "<b>История и редактирование:</b>\n"
        "📝 «Мои продажи» → просмотр своих продаж и редактирование при необходимости."
    ),
    "reports": (
    ...
    "notifications": (
        ...
        "<b>Настройки:</b>\n"
        "«👤 Мой профиль» → «🔔 Уведомления» → включите или выключите каждый тип "
        "уведомлений отдельно."
    ),
    "profile": (
        ...
        "«Мой профиль» → «📞 Контакты» — список контактов вашей организации "
        "(телефоны, мессенджеры).\n\n"
        "<b>💳 Подписка:</b>\n"
        "«Мой профиль» → «💳 Подписка» — текущий тариф, срок действия, история платежей.\n\n"
    ...
    "staff": (
        ...
        "«👥 Упр. сотрудниками» → инвайт-код → поделитесь кодом с новым сотрудником. "
        "При регистрации через /start он выбирает «Присоединиться к организации» "
        "и вводит этот код.\n\n"
        "<b>Роли:</b>\n"
        "• <b>owner</b> — владелец, полный доступ ко всему\n"
        "• <b>admin</b> — администратор с настраиваемым скоупом видимости\n"
        "• <b>user</b> — продавец (только свои продажи и базовые отчёты)\n\n"
        "<b>Скоуп (область видимости):</b>\n"
        "Ограничьте доступ сотрудника — он видит только данные своего магазина, "
        "города или торговой сети. Остальные данные скрыты.\n\n"
    ...
    "products": (
        ...
        "<b>Категории:</b>\n"
        "Создавайте категории для удобной фильтрации товаров в продажах и отчётах.\n\n"
        "<b>Редактирование и удаление:</b>\n"
        "«✏️ Редактировать» — изменить название, категорию или цену товара.\n"
    ...
    "motivation": (
        ...
        "Отмечайте рабочие дни в календаре. Итог = ставка × количество смен.\n\n"
        "<b>Шаблоны смен:</b>\n"
    ...
    "plans": (
        ...
        "прогресса и фактическими данными.\n\n"
        "<b>Для продавца:</b>\n"
    ...
    "sheets": (
        ...
        "<b>Важно:</b>\n"
        "Интеграция работает для всей организации — продажи всех продавцов "
        "попадают в одну таблицу. Поле «Продавец» позволяет фильтровать по сотруднику."
    ),
    "subscription": (
    ...
    "system": (
        ...
        "Подтверждение и отклонение заявок на оплату (СБП-переводы). "
        "Заявки старше 72ч отклоняются автоматически.\n\n"
        "<b>💾 Резервные копии:</b>\n"
        "Создание .zip-архива всех баз данных и скачивание прямо в Telegram. "
        "Храните резервные копии в надёжном месте!\n\n"
        "<b>🧪 Системные тесты:</b>\n"
        "Запуск проверки всех модулей импортов (45 тестов) прямо из бота.\n\n"
        "<b>Режимы работы:</b>\n"
