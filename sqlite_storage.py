...
class SQLiteStorage(BaseStorage):
    ...
    async def set_state(self, key: StorageKey, state: StateType = None) -> None:
        ...
        await loop.run_in_executor(None, self._sync_set_state, key, state_str)
    ...
    async def get_state(self, key: StorageKey) -> Optional[str]:
        loop = asyncio.get_event_loop()
        return await loop.run_in_executor(None, self._sync_get_state, key)
    ...
    async def set_data(self, key: StorageKey, data: Dict[str, Any]) -> None:
        loop = asyncio.get_event_loop()
        await loop.run_in_executor(None, self._sync_set_data, key, data)
    ...
    async def get_data(self, key: StorageKey) -> Dict[str, Any]:
        loop = asyncio.get_event_loop()
        return await loop.run_in_executor(None, self._sync_get_data, key)
