...
ENTRIES = [
    {
        ...
        "date": "31 июля 2026",
        "items": [
            "Update agent handoff docs and add inventory page assets",
        ],
    },
    {
        "version": "1.451.0",
        "date": "31 июля 2026",
        "items": [
            "Update agent handoff documentation and add base web template",
        ],
    },
    {
        "version": "1.450.0",
    ...
    },
    {
        ...
        "date": "31 июля 2026",
        "items": [
            "Implement inventory management features and update documentation",
        ],
    },
    {
        "version": "1.448.0",
    ...
    },
    {
        ...
        "date": "28 июля 2026",
        "items": [
            "Update subscription management logic and UI and document changes",
        ],
    },
    {
        "version": "1.443.0",
        "date": "28 июля 2026",
        "items": [
            "Implement payment admin handlers and update subscription routing",
        ],
    },
    {
        "version": "1.442.0",
    ...
    },
    {
        ...
        "date": "27 июля 2026",
        "items": [
            "Implement subscription management features and update UI templates",
            "Add screenshot assets for reference",
        ],
    },
    {
        "version": "1.440.0",
    ...
    },
    {
        ...
        "date": "9 июля 2026",
        "items": [
            "Add rollback to prevent orphaned credentials during corporate registration",
        ],
    },
    {
        "version": "1.436.0",
    ...
    },
    {
        ...
        "date": "7 июля 2026",
        "items": [
            "Update application version and release notes with improvements",
        ],
    },
    {
        "version": "1.419.0",
        "date": "7 июля 2026",
        "items": [
            "Update application version and release notes with bug fixes and improvements",
            "Keep session fresh when a user's role changes",
        ],
    },
    {
        "version": "1.418.0",
    ...
    },
    {
        ...
        "date": "7 июля 2026",
        "items": [
            "Update deployment and version information for latest changes",
        ],
    },
    {
        "version": "1.403.0",
        "date": "7 июля 2026",
        "items": [
            "Update deployment script to properly encode GitHub token",
        ],
    },
    {
        "version": "1.402.0",
        "date": "7 июля 2026",
        "items": [
            "Add client management and services booking features",
        ],
    },
    {
        "version": "1.401.0",
        "date": "7 июля 2026",
        "items": [
            "**Клиенты/CRM** (бесплатно)",
            "- База клиентов: ФИО, телефон, email, день рождения, источник, теги, заметки",
            "- Карточка клиента с историей покупок и записей, расчёт LTV",
            "- Поиск по имени/телефону/email, фильтрация по тегам",
            "- Экспорт в Excel",
            "- Управление из бота: список, поиск, добавление, карточка",
            "**Услуги** (499 ₽/мес)",
            "- Каталог услуг с категориями, ценами и длительностью",
            "- Поддержка групповых услуг (до N участников)",
            "- Записи клиентов: создание, статусы (запланирована→подтверждена→выполнена), история",
            "- Календарь записей по месяцам",
            "- Проверка занятости мастера при создании записи",
            "- Расширение «Мотивация за услуги» (149 ₽): комиссии мастеров по % или фиксированной сумме",
            "- Напоминания мастерам за 1 час до записи",
            "- Управление из бота: каталог, мои записи, смена статуса",
        ],
    },
    {
        "version": "1.400.0",
        "date": "4 июля 2026",
        "items": [
            "Improve sales return calculations and fix various display issues",
        ],
    },
    {
        "version": "1.399.0",
    ...
    },
    {
        ...
        "date": "3 июля 2026",
        "items": [
            "Возвраты в дашборде и отчётах: карточка возвратов за месяц на главном экране, строка возвратов + выручка нетто в веб-отчётах, данные о возвратах в отчёте за период в боте; «Возвраты» добавлены в десктопный сайдбар",
            "возвраты уменьшают зарплату продавца",
            "Add returns tracking to the dashboard and reports",
        ],
    },
    {
        "version": "1.394.0",
        "date": "3 июля 2026",
        "items": [
            "Возвраты товаров теперь автоматически уменьшают мотивацию продавца: пропорциональный вычет отображается отдельной строкой в расчётном листке (бот и веб), в итогах зарплаты и в Excel-ведомости.",
            "атомарная защита от двойного возврата одной продажи (Task #106)",
        ],
    },
    {
        "version": "1.393.0",
        "date": "3 июля 2026",
        "items": [
            "защита от двойного возврата одной продажи (Task #106)",
        ],
    },
    {
        "version": "1.392.0",
    ...
    },
    {
        ...
        "date": "3 июля 2026",
        "items": [
            "Fix issues displaying employee salary and absence information",
        ],
    },
    {
        "version": "1.384.0",
    ...
    },
    {
        ...
        "items": [
            "Update deployment status and implement new absence merging logic",
            "Prevent absence merge from silently succeeding across different employees",
            "Confirm merging absences keeps salary and worked-day counts correct",
        ],
    },
    {
        "version": "1.372.0",
    ...
    },
    {
        ...
        "date": "3 июля 2026",
        "items": [
            "Расчёт среднего заработка теперь учитывает историю изменений дневной ставки — отпускные считаются точнее, если ставка менялась в течение года.",
            "История дневных ставок для точного расчёта среднего заработка",
        ],
    },
    {
        "version": "1.364.0",
    ...
    },
    {
        ...
        "date": "2 июля 2026",
        "items": [
            "Отпускные по среднему дневному заработку за 12 мес",
        ],
    },
    {
        "version": "1.362.0",
    ...
    },
    {
        ...
        "date": "2 июля 2026",
        "items": [
            "Отпускные теперь рассчитываются по среднему дневному заработку за 12 месяцев (оклад + мотивация / рабочие дни), а не просто ставка × дни. Формула отображается в расчётном листке.",
            "timeline-splitting для partial vacation, vacation-only исключение, 740 тестов",
        ],
    },
    {
        "version": "1.359.0",
        "date": "2 июля 2026",
        "items": [
            "Совместная мотивация (joint): исправлена логика частичного отпуска и типов отсутствий",
            "joint-мотивация — исправление sellers_count и vacation-исключение",
        ],
    },
    {
        "version": "1.358.0",
    ...
    },
    {
        ...
        "date": "1 июля 2026",
        "items": [
            "Add a header title to the AI history page for better navigation",
        ],
    },
    {
        "version": "1.351.0",
    ...
    },
    {
        ...
        "date": "1 июля 2026",
        "items": [
            "Fix filter functionality by replacing inline event handlers with submit buttons",
        ],
    },
    {
        "version": "1.349.0",
        "date": "1 июля 2026",
        "items": [
            "Add AI feature logging and history improvements",
        ],
    },
    {
        "version": "1.348.0",
    ...
    },
    {
        ...
        "date": "1 июля 2026",
        "items": [
            "Update AI history page to correctly display user information",
        ],
    },
    {
        "version": "1.345.0",
        "date": "1 июля 2026",
        "items": [
            "Fix AI history display and update version information",
        ],
    },
    {
        "version": "1.344.0",
        "date": "1 июля 2026",
        "items": [
            "Add a personal history log for AI interactions and responses",
        ],
    },
    {
        "version": "1.343.0",
    ...
    },
    {
        ...
        "date": "1 июля 2026",
        "items": [
            "Update project documentation to reflect recent development and testing efforts",
        ],
    },
    {
        "version": "1.340.0",
    ...
    },
    {
        ...
        "date": "30 июня 2026",
        "items": [
            "Напоминания, оценка задачи и подзадачи в боте",
        ],
    },
    {
        "version": "1.330.0",
    ...
    },
    {
        ...
        "date": "30 июня 2026",
        "items": [
            "Чеклист-toggle, фильтр по статусу, прямая ссылка на задачу",
        ],
    },
    {
        "version": "1.327.0",
        "date": "30 июня 2026",
        "items": [
            "Комментарии к задаче в боте (+ security fixes)",
        ],
    },
    {
        "version": "1.326.0",
    ...
    },
    {
        ...
        "date": "30 июня 2026",
        "items": [
            "редактирование задачи из бота — полная реализация",
        ],
    },
    {
        "version": "1.323.0",
    ...
    },
    {
        ...
        "date": "30 июня 2026",
        "items": [
            "редактирование задачи из бота (FSM-wizard)",
        ],
    },
    {
        "version": "1.321.0",
    ...
    },
    {
        ...
        "date": "29 июня 2026",
        "items": [
            "⚙️ Автоматизация задач: правила «событие → действие» (уведомить, сменить статус/приоритет, добавить комментарий) — настраиваются в разделе «Задачи → Автоматизация»",
            "⏱ Контроль сроков (SLA): задаёте время реакции и решения по приоритету, бот сам подсвечивает «угроза»/«нарушено» и эскалирует просрочку руководителю",
            "🔎 Живой поиск и фильтры в списке задач — результаты обновляются на лету, без перезагрузки страницы",
            "salary list bulk query, eliminates N+1 (150+ queries → 7–9)",
            "Add project management features for tasks and dependencies",
        ],
    },
    {
        "version": "1.308.0",
    ...
    },
    {
        ...
        "date": "29 июня 2026",
        "items": [
            "stability: try/finally for db connections, future-month salary guard, OAuth refresh fallback",
        ],
    },
    {
        "version": "1.305.0",
    ...
    },
    {
        ...
        "date": "28 июня 2026",
        "items": [
            "перенос экспортов и кэш мотивации в веб-интерфейсе (v2)",
        ],
    },
    {
        "version": "1.298.0",
        "date": "28 июня 2026",
        "items": [
            "перенос экспортов и кэш мотивации в веб-интерфейсе",
        ],
    },
    {
        "version": "1.297.0",
    ...
    },
    {
        ...
        "date": "28 июня 2026",
        "items": [
            "Add \"sync sales for current week\" to web integration page",
        ],
    },
    {
        "version": "1.293.0",
    ...
    },
    {
        ...
        "date": "28 июня 2026",
        "items": [
            "Improve product search to show out-of-stock items",
        ],
    },
    {
        "version": "1.280.0",
    ...
    },
    {
        ...
        "date": "28 июня 2026",
        "items": [
            "Improve flash banner auto-dismiss and closing functionality",
        ],
    },
    {
        "version": "1.278.0",
    ...
    },
    {
        ...
        "date": "28 июня 2026",
        "items": [
            "Improve task detail display and message handling",
        ],
    },
    {
        "version": "1.276.0",
    ...
    },
    {
        ...
        "date": "27 июня 2026",
        "items": [
            "Update application documentation and version number",
        ],
    },
    {
        "version": "1.274.0",
    ...
    },
    {
        ...
        "date": "27 июня 2026",
        "items": [
            "Organize settings page into user-friendly tabs for better navigation",
        ],
    },
    {
        "version": "1.272.0",
    ...
    },
    {
        ...
        "date": "27 июня 2026",
        "items": [
            "Fix duplicate responses when toggling automatic synchronization",
        ],
    },
    {
        "version": "1.268.0",
    ...
    },
    {
        ...
        "date": "27 июня 2026",
        "items": [
            "Make the direct message list fill the full screen width on mobile devices",
        ],
    },
    {
        "version": "1.266.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Update documentation and release notes with latest deployment details",
        ],
    },
    {
        "version": "1.261.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Update project to fix login and add new tests",
            "Show backup download history on the admin backups page",
        ],
    },
    {
        "version": "1.256.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Update project documentation and version information",
            "Add backup download audit log entry",
        ],
    },
    {
        "version": "1.253.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Update documentation and version with recent changes",
        ],
    },
    {
        "version": "1.249.0",
        "date": "26 июня 2026",
        "items": [
            "Защитить имена файлов при скачивании бэкапов баз данных",
        ],
    },
    {
        "version": "1.248.0",
        "date": "26 июня 2026",
        "items": [
            "Покрыть браузерными тестами экран регистрации и сброса пароля",
        ],
    },
    {
        "version": "1.247.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Расширить браузерные проверки на вход и оформление продажи",
        ],
    },
    {
        "version": "1.244.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Update documentation to clarify post-session procedures",
        ],
    },
    {
        "version": "1.242.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Update application with new features and deployment information",
        ],
    },
    {
        "version": "1.239.0",
        ...
        "items": [
            ...
            "Просмотр чека оплаты в веб-панели",
            "Восстановление бэкапа через веб-панель",
            "Управление инвентарём для рядовых сотрудников",
            "Таргетинг рассылок по конкретным сотрудникам",
        ],
    },
    {
        "version": "1.238.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Синхронизация мотивации из Google Sheets: автосинк по расписанию (06:05 UTC), раздельные псевдонимы сетей и моделей, исправлен формат колонок бонусов (теперь `2:DNS, 3:МВМ`), статистика синхронизации в веб-кабинете (правил записано / сопоставлено товаров)",
        ],
    },
    {
        "version": "1.236.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Improve chat swipe hint visibility and behavior for better user experience",
        ],
    },
    {
        "version": "1.234.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Improve swipe gesture behavior and fix lingering navigation hints in chat",
        ],
    },
    {
        "version": "1.227.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Update deployment status and application version",
        ],
    },
    {
        "version": "1.222.0",
    ...
    },
    {
        ...
        "date": "26 июня 2026",
        "items": [
            "Task #56 — task reminders, bot history, AI button, team deadlines, UTC offset, recurring notify",
        ],
    },
    {
        "version": "1.217.0",
    ...
    },
    {
        ...
        "date": "25 июня 2026",
        "items": [
            "Implement enhanced security measures and update system components",
        ],
    },
    {
        "version": "1.211.0",
    ...
    },
    {
        ...
        "date": "25 июня 2026",
        "items": [
            "Право на забвение (ФЗ-152/GDPR): супер-администратор теперь может стереть персональные данные конкретного пользователя из всех баз организаций — через «Глобальный поиск пользователей» → кнопка «Стереть ПДн». Уничтожаются: ФИО, телефон, email, фото профиля, история IP, тексты переписки. Бизнес-записи (продажи, зарплатные корректировки) сохраняются в анонимном виде. Каждая операция фиксируется в аудит-логе.",
            "Improve security by fixing cross-site scripting vulnerabilities",
        ],
    },
    {
        "version": "1.209.0",
    ...
    },
    {
        ...
        "date": "25 июня 2026",
        "items": [
            "Update documentation to reflect completed security improvements",
        ],
    },
    {
        "version": "1.206.0",
    ...
    },
    {
        ...
        "date": "25 июня 2026",
        "items": [
            "Implement chat message retention and update privacy policy",
        ],
    },
    {
        "version": "1.203.0",
