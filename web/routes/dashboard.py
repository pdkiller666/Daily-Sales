...
_GATE_MSGS = {
    # ── Legacy keys (kept for backwards-compat; old bookmarks / cached pages) ──
    ...
    # ── Active keys (owners → /subscription, non-owners → /dashboard) ──
    "analytics_locked":          ("📊 Модуль «Аналитика» не подключён",        "Этот раздел доступен по подписке. Владелец организации может подключить модуль в разделе Подписка → Модули."),
    "plans_motivation_locked":   ("🎯 Модуль «Планы и мотивация» не подключён", "Этот раздел доступен по подписке. Владелец организации может подключить модуль в разделе Подписка → Модули."),
    "team_locked":               ("👥 Модуль «Команда» не подключён",           "Этот раздел доступен по подписке. Владелец организации может подключить модуль в разделе Подписка → Модули."),
    "notifications_locked":      ("🔔 Модуль «Уведомления» не подключён",       "Этот раздел доступен по подписке. Владелец организации может подключить модуль в разделе Подписка → Модули."),
    "crm_locked":                ("📇 Модуль «CRM» не подключён",               "Этот раздел доступен по подписке. Владелец организации может подключить модуль в разделе Подписка → Модули."),
    "contests_locked":           ("🏆 Расширение «Конкурсы» не подключено",     "Этот раздел доступен по подписке. Владелец организации может подключить расширение в разделе Подписка → Модули."),
    ...
    # ── Extension-within-section keys (stay on section page, not in subscription) ──
...
def dashboard(request: Request, msg: str = ""):
    ...
    from web.deps import get_web_db, get_user_org_db_path, get_user_role_from_db
