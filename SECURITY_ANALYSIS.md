...
> **Дата последнего аудита:** 26 июня 2026 (security-аудит); документация актуализирована 9 июля 2026 (импорт в Replit)  
> **Охват:** web-слой (FastAPI), бот (aiogram), database.py, шаблоны Jinja2, деплой-инфраструктура  
> **Версия:** GitHub `28099f7` · подробный отчёт по коду — см. `AUDIT_REPORT_2026-07-08.md`
