...
Sales/inventory/daily reports · multi-org with invite codes & roles · sales plans + milestone alerts · dashboards · contests · work schedules + shift templates · salary transparency · subscriptions/payments (SBP + YooKassa) + modular billing · rankings · Excel import/export · Google Sheets integration · internal org chat (topics + DM; реакции/ответы/упоминания @/правка/закреп (группы)/двойные галочки ✓✓ (ЛС)/пересылка/live-WS) · push & browser notifications · email/password login · flexible org structure.
